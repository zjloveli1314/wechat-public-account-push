...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxe328a301210e13f5',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'be552e41c1a02e1119a0d86a6827b48d',
   ...
   */
  USERS: [o-G386mB3YX0Q2ipXyglpEothK2Q
    {
      // 想要发送的人的名字
      name: '宝贝0',
      ...
      id: '',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '-ZVlOW_xFxDt8oAnu1SgE3p4RREacjl51cry56L3eB0',
      // 所在省份
      province: '安徽',
      // 所在城市
      city: '滁州',
      ...
      openUrl: 'https://search.bilibili.com/all?keyword=%E5%88%98%E6%96%87%E8%B6%85&from_source=webtop_search&spm_id_from=333.1007&search_source=5',
